...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal List<DML.Cliente> Listar()
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("ID", Convert.ToInt64(0)));
        ...
        private List<DML.Cliente> Converter(DataSet ds, bool getCpf = false)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    if (getCpf) { cli.CPF = row.Field<string>("CPF"); }
